                        ...
                        <table class="table align-items-center mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder ps-2 opacity-7">Created by</th>
                                ...
                                <?php if (!empty($lists)) {
                                    foreach ($lists as $value) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <p class="text-xs font-weight-bold mb-0"><?php echo $value['parent_id']  ?></p>
                                            </td>
                                            <td>
                                                <p class="text-xs font-weight-bold mb-0"><?php echo $value['slug'] ?></p>
                                            </td>
                                            <td class="align-middle text-center">
                                                <span class="text-secondary text-xs font-weight-bold"><?php echo $value['created_at'] ?></span>
                                            </td>
